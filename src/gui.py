...
class Gui(tk.Tk):
    def __init__(self, screenName: str | None = None, baseName: str | None = None, className: str = "Tk", useTk: bool = True, sync: bool = False, use: str | None = None) -> None:
        ...
        self.fields_label = ttk.Label(self.run_info_details, text='Fields:')
        self.records_label = ttk.Label(self.run_info_details, text='Records:')
        self.shapes_label = ttk.Label(self.run_info_details, text='Shapes:')
        ...
        self.run_info_details.columnconfigure(index=2, weight=1)
        ...
        self.fields_label.grid(row=0, column=0, sticky='nw', padx=2)
        self.records_label.grid(row=0, column=1, sticky='nw', padx=2)
        self.shapes_label.grid(row=0, column=2, sticky='nw', padx=2) 
